  ...
  <main class="chat-page" :class="{ 'sidebar-collapsed': sidebarCollapsed, 'settings-hidden': !settingsVisible }">
    ...
    <section class="chat-workspace">
      <header class="chat-topbar">
        ...
        <div class="topbar-actions"><el-button @click="router.push('/knowledge-bases')">知识库</el-button><el-button @click="router.push('/faqs')">FAQ</el-button><el-button @click="router.push('/tickets')">人工工单</el-button><span class="trust-indicator"><i />政策时效与地区过滤已启用</span><el-button :icon="Setting" circle @click="settingsVisible = !settingsVisible" /></div>
      </header>
