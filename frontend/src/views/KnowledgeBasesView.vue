...
<template>
  <main class="management-page">
    <header class="management-header"><div class="management-brand"><span>税</span><div><strong>TaxMind</strong><small>知识资产中心</small></div></div><nav><el-button text @click="router.push('/tickets')">人工工单</el-button><el-button text @click="router.push('/faqs')">FAQ 管理</el-button><el-button text :icon="ArrowLeft" @click="router.push('/chat')">返回智能问答</el-button></nav></header>
